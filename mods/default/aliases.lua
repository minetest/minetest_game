...
-- Aliases for moreores additions
...
minetest.register_alias("moreores:silver_block", "default:silver_block")
minetest.register_alias("moreores:mithril_block", "default:mithril_block")
