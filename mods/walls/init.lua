...
walls.register = function(wall_name, wall_desc, wall_texture_table, wall_mat, wall_sounds)
	...
	minetest.register_node(wall_name, {
		...
		node_box = {
			...
			-- connect_bottom =
			connect_front = {{-3/16, -5/8, -1/2,  3/16, 3/8, -1/4}},
			connect_left = {{-1/2, -5/8, -3/16, -1/4, 3/8,  3/16}},
			connect_back = {{-3/16, -5/8,  1/4,  3/16, 3/8,  1/2}},
			connect_right = {{ 1/4, -5/8, -3/16,  1/2, 3/8,  3/16}},
		},
