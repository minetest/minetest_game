...
--
newgrass1 = minetest.clone_node("default:grass_1")
	newgrass1.drop = {
		max_items = 1,
		items = {
...
minetest.register_node(":default:grass_1", newgrass1)
...
newgrass = minetest.clone_node("default:junglegrass")
	newgrass.drop = {
		max_items = 1,
		items = {
...
minetest.register_node(":default:junglegrass", newgrass)
